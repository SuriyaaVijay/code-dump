...
public:
    ...
    [[eosio::action]] void initblog(name authority)
    {
    ...
    [[eosio::action]] void signupuser(name authority, string name, string avatar)
    {
        require_auth(authority);
    ...
    [[eosio::action]] void createpost(name authority, string title, string content, name user)
    {
        require_auth(authority);
